...
from cnake_data.cy.simulation.particle_bounce import particle_bounce as cy_func
from cnake_data.py.simulation.particle_bounce import particle_bounce as py_func
