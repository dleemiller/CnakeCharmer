...
from cnake_charmer.cy.geometry.polyline_simplify import polyline_simplify as cy_func
from cnake_charmer.py.geometry.polyline_simplify import polyline_simplify as py_func
