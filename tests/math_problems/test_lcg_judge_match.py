...
from cnake_charmer.cy.math_problems.lcg_judge_match import lcg_judge_match as cy_lcg_judge_match
from cnake_charmer.py.math_problems.lcg_judge_match import lcg_judge_match as py_lcg_judge_match
