...
from cnake_data.cy.numerical.simpson_integration import simpson_integration as cy_func
from cnake_data.py.numerical.simpson_integration import simpson_integration as py_func
