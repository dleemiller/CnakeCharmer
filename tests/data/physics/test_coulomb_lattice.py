...
from cnake_data.cy.physics.coulomb_lattice import coulomb_lattice as cy_coulomb_lattice
from cnake_data.py.physics.coulomb_lattice import coulomb_lattice as py_coulomb_lattice
