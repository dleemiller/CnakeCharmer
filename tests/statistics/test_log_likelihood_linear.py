...
from cnake_charmer.cy.statistics.log_likelihood_linear import log_likelihood_linear as cy_func
from cnake_charmer.py.statistics.log_likelihood_linear import log_likelihood_linear as py_func
