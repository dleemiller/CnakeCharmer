...
from cnake_data.cy.numerical.cpdef_clamp_sum import cpdef_clamp_sum as cy_func
from cnake_data.py.numerical.cpdef_clamp_sum import cpdef_clamp_sum as py_func
