...
from cnake_data.cy.numerical.complex_multiply_sum import complex_multiply_sum as cy_func
from cnake_data.py.numerical.complex_multiply_sum import complex_multiply_sum as py_func
