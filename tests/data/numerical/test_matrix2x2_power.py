...
from cnake_data.cy.numerical.matrix2x2_power import matrix2x2_power as cy_func
from cnake_data.py.numerical.matrix2x2_power import matrix2x2_power as py_func
