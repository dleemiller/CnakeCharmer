...
from cnake_data.cy.numerical.dot_product import dot_product as cy_dot_product
from cnake_data.py.numerical.dot_product import dot_product as py_dot_product
