...
from cnake_charmer.cy.geometry.crosses_dateline_count import crosses_dateline_count as cy_func
from cnake_charmer.py.geometry.crosses_dateline_count import crosses_dateline_count as py_func
