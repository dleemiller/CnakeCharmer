...
from cnake_charmer.cy.statistics.trend_correlation import trend_correlation as cy_func
from cnake_charmer.py.statistics.trend_correlation import trend_correlation as py_func
