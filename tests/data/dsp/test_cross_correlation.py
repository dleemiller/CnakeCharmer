...
from cnake_data.cy.dsp.cross_correlation import cross_correlation as cy_cross_correlation
from cnake_data.py.dsp.cross_correlation import cross_correlation as py_cross_correlation
