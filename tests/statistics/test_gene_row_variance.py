...
from cnake_charmer.cy.statistics.gene_row_variance import gene_row_variance as cy_func
from cnake_charmer.py.statistics.gene_row_variance import gene_row_variance as py_func
