...
from cnake_data.cy.diff_equations.method_of_lines import method_of_lines as cy_func
from cnake_data.py.diff_equations.method_of_lines import method_of_lines as py_func
