...
from cnake_data.cy.dsp.pitch_detect_amdf import pitch_detect_amdf as cy_func
from cnake_data.py.dsp.pitch_detect_amdf import pitch_detect_amdf as py_func
