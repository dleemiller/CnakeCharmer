...
from cnake_data.cy.numerical.lookup_table_eval import lookup_table_eval as cy_func
from cnake_data.py.numerical.lookup_table_eval import lookup_table_eval as py_func
