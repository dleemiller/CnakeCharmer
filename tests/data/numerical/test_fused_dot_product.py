...
from cnake_data.cy.numerical.fused_dot_product import fused_dot_product as cy_fused_dot_product
from cnake_data.py.numerical.fused_dot_product import fused_dot_product as py_fused_dot_product
