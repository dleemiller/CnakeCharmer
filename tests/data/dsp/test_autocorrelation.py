...
from cnake_data.cy.dsp.autocorrelation import autocorrelation as cy_autocorrelation
from cnake_data.py.dsp.autocorrelation import autocorrelation as py_autocorrelation
