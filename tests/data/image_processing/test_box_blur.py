...
from cnake_data.cy.image_processing.box_blur import box_blur as cy_box_blur
from cnake_data.py.image_processing.box_blur import box_blur as py_box_blur
