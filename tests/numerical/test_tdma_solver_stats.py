...
from cnake_charmer.cy.numerical.tdma_solver_stats import tdma_solver_stats as cy_func
from cnake_charmer.py.numerical.tdma_solver_stats import tdma_solver_stats as py_func
