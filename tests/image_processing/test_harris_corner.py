...
from cnake_charmer.cy.image_processing.harris_corner import harris_corner as cy_func
from cnake_charmer.py.image_processing.harris_corner import harris_corner as py_func
