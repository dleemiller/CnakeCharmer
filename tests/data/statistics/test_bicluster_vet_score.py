...
from cnake_data.cy.statistics.bicluster_vet_score import bicluster_vet_score as cy_func
from cnake_data.py.statistics.bicluster_vet_score import bicluster_vet_score as py_func
