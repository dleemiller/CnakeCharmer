...
from cnake_data.cy.physics.blackbody_radiation import blackbody_radiation as cy_func
from cnake_data.py.physics.blackbody_radiation import blackbody_radiation as py_func
