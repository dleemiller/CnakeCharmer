...
from cnake_charmer.cy.dsp.envelope_detection import envelope_detection as cy_envelope_detection
from cnake_charmer.py.dsp.envelope_detection import envelope_detection as py_envelope_detection
