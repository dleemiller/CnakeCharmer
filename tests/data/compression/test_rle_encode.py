...
from cnake_data.cy.compression.rle_encode import rle_encode as cy_rle_encode
from cnake_data.py.compression.rle_encode import rle_encode as py_rle_encode
