...
Example usage:
    ...
    from cnake_data.benchmarks.registry import python_benchmark, cython_benchmark
...
def _register_benchmark(
    ...
    *,
    ...
    # Extract category from module path: cnake_data.{py|cy}.{category}.{name}
    category = ""
    module = getattr(func, "__module__", "")
    parts = module.split(".")
    if len(parts) >= 3:
        category = parts[-2]  # e.g. "nn_ops" from "cnake_data.py.nn_ops.relu"
