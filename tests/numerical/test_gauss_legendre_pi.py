...
from cnake_charmer.cy.numerical.gauss_legendre_pi import gauss_legendre_pi as cy_func
from cnake_charmer.py.numerical.gauss_legendre_pi import gauss_legendre_pi as py_func
