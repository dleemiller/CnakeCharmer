...
from cnake_charmer.cy.numerical.union_int_float import union_int_float as cy_func
from cnake_charmer.py.numerical.union_int_float import union_int_float as py_func
