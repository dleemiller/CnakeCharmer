...
from cnake_charmer.cy.geometry.vec3_class_cross_norm import vec3_class_cross_norm as cy_func
from cnake_charmer.py.geometry.vec3_class_cross_norm import vec3_class_cross_norm as py_func
