...
from cnake_charmer.cy.statistics.chi_squared import chi_squared as cy_chi_squared
from cnake_charmer.py.statistics.chi_squared import chi_squared as py_chi_squared
