...
from cnake_charmer.cy.algorithms.byte_mixer_stream_class import byte_mixer_stream_class as cy_func
from cnake_charmer.py.algorithms.byte_mixer_stream_class import byte_mixer_stream_class as py_func
