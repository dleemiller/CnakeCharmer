...
from cnake_data.cy.statistics.cosine_similarity import cosine_similarity as cy_func
from cnake_data.py.statistics.cosine_similarity import cosine_similarity as py_func
