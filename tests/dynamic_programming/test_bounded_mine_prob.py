...
from cnake_charmer.cy.dynamic_programming.bounded_mine_prob import bounded_mine_prob as cy_func
from cnake_charmer.py.dynamic_programming.bounded_mine_prob import bounded_mine_prob as py_func
