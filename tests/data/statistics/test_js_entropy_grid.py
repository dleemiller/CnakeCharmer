...
from cnake_data.cy.statistics.js_entropy_grid import js_entropy_grid as cy_func
from cnake_data.py.statistics.js_entropy_grid import js_entropy_grid as py_func
