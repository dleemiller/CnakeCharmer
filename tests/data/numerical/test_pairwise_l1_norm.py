...
from cnake_data.cy.numerical.pairwise_l1_norm import pairwise_l1_norm as cy_func
from cnake_data.py.numerical.pairwise_l1_norm import pairwise_l1_norm as py_func
