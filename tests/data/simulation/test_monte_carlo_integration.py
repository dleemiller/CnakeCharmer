...
from cnake_data.cy.simulation.monte_carlo_integration import monte_carlo_integration as cy_func
from cnake_data.py.simulation.monte_carlo_integration import monte_carlo_integration as py_func
