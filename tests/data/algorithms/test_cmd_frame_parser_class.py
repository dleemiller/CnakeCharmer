...
from cnake_data.cy.algorithms.cmd_frame_parser_class import cmd_frame_parser_class as cy_func
from cnake_data.py.algorithms.cmd_frame_parser_class import cmd_frame_parser_class as py_func
