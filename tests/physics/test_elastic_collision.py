...
from cnake_charmer.cy.physics.elastic_collision import elastic_collision as cy_func
from cnake_charmer.py.physics.elastic_collision import elastic_collision as py_func
