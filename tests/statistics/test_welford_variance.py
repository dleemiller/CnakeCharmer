...
from cnake_charmer.cy.statistics.welford_variance import welford_variance as cy_func
from cnake_charmer.py.statistics.welford_variance import welford_variance as py_func
