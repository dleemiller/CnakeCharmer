...
from cnake_charmer.cy.physics.doppler_shift import doppler_shift as cy_func
from cnake_charmer.py.physics.doppler_shift import doppler_shift as py_func
