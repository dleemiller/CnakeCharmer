...
from cnake_charmer.cy.leetcode.max_subarray_variants import max_subarray_variants as cy_func
from cnake_charmer.py.leetcode.max_subarray_variants import max_subarray_variants as py_func
