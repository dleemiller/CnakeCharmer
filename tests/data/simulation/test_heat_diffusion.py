...
from cnake_data.cy.simulation.heat_diffusion import heat_diffusion as cy_func
from cnake_data.py.simulation.heat_diffusion import heat_diffusion as py_func
