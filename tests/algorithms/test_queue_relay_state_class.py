...
from cnake_charmer.cy.algorithms.queue_relay_state_class import queue_relay_state_class as cy_func
from cnake_charmer.py.algorithms.queue_relay_state_class import queue_relay_state_class as py_func
