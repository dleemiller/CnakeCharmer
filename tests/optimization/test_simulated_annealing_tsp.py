...
from cnake_charmer.cy.optimization.simulated_annealing_tsp import simulated_annealing_tsp as cy_func
from cnake_charmer.py.optimization.simulated_annealing_tsp import simulated_annealing_tsp as py_func
