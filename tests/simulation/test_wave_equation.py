...
from cnake_charmer.cy.simulation.wave_equation import wave_equation as cy_func
from cnake_charmer.py.simulation.wave_equation import wave_equation as py_func
