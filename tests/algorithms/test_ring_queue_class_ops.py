...
from cnake_charmer.cy.algorithms.ring_queue_class_ops import ring_queue_class_ops as cy_func
from cnake_charmer.py.algorithms.ring_queue_class_ops import ring_queue_class_ops as py_func
