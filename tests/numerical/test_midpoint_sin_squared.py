...
from cnake_charmer.cy.numerical.midpoint_sin_squared import midpoint_sin_squared as cy_func
from cnake_charmer.py.numerical.midpoint_sin_squared import midpoint_sin_squared as py_func
