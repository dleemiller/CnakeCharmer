...
from cnake_charmer.cy.nn_ops.softmax_stable import softmax_stable as cy_func
from cnake_charmer.py.nn_ops.softmax_stable import softmax_stable as py_func
