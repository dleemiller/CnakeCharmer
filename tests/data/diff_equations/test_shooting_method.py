...
from cnake_data.cy.diff_equations.shooting_method import shooting_method as cy_func
from cnake_data.py.diff_equations.shooting_method import shooting_method as py_func
