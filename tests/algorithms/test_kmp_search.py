...
from cnake_charmer.cy.algorithms.kmp_search import kmp_search as cy_kmp_search
from cnake_charmer.py.algorithms.kmp_search import kmp_search as py_kmp_search
