...
from cnake_charmer.cy.statistics.stats_single_pass import stats_single_pass as cy_stats
from cnake_charmer.py.statistics.stats_single_pass import stats_single_pass as py_stats
