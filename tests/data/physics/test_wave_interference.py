...
from cnake_data.cy.physics.wave_interference import wave_interference as cy_func
from cnake_data.py.physics.wave_interference import wave_interference as py_func
