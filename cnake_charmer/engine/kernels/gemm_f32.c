...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cnake_charmer.engine.kernels.gemm_f32",
        "sources": [
            "cnake_charmer/engine/kernels/gemm_f32.pyx"
        ]
    },
    "module_name": "cnake_charmer.engine.kernels.gemm_f32"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cnake_charmer__engine__kernels__gemm_f32
#define __PYX_HAVE_API__cnake_charmer__engine__kernels__gemm_f32
/* Early includes */
#include "string.h"
#include "immintrin.h"
#ifdef _OPENMP
...
/* Module declarations from "cnake_charmer.engine.kernels.gemm_f32" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cnake_charmer.engine.kernels.gemm_f32"
extern int __pyx_module_is_main_cnake_charmer__engine__kernels__gemm_f32;
int __pyx_module_is_main_cnake_charmer__engine__kernels__gemm_f32 = 0;

/* Implementation of "cnake_charmer.engine.kernels.gemm_f32" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_GEMM_f32_kernels_scalar_and_XNNP[] = "GEMM f32 kernels \342\200\224 scalar and XNNPACK-style 4x8 AVX2 FMA.\n\nPure compute, no allocation. Caller provides pre-allocated A, B, C.\nC must be pre-zeroed (or accumulated into).\n";
/* #### Code section: decls ### */
...
#define __pyx_kp_b_void_float_const_float_const_flo __pyx_string_tab[9]
...
/* "cnake_charmer/engine/kernels/gemm_f32.pyx":21
 * 
 * 
...
static void __pyx_f_13cnake_charmer_6engine_7kernels_8gemm_f32_gemm_f32(float const *__pyx_v_A, float const *__pyx_v_B, float *__pyx_v_C, int __pyx_v_M, int __pyx_v_N, int __pyx_v_K) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  float __pyx_v_a_ik;
  ...
  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":27
 *     cdef float a_ik
 * 
 ...
 *     for i in range(M):
*/
  (void)(memset(__pyx_v_C, 0, ((__pyx_v_M * __pyx_v_N) * (sizeof(float)))));

  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":29
 *     memset(C, 0, M * N * sizeof(float))
 * 
 *     for i in range(M):             # <<<<<<<<<<<<<<
 *         for k in range(K):
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cnake_charmer/engine/kernels/gemm_f32.pyx":30
 * 
 *     for i in range(M):
 *         for k in range(K):             # <<<<<<<<<<<<<<
 *             a_ik = A[i * K + k]
...
*/
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":31
 *     for i in range(M):
 *         for k in range(K):
 *             a_ik = A[i * K + k]             # <<<<<<<<<<<<<<
 *             for j in range(N):
...
*/
      __pyx_v_a_ik = (__pyx_v_A[((__pyx_v_i * __pyx_v_K) + __pyx_v_k)]);

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":32
 *         for k in range(K):
 *             a_ik = A[i * K + k]
 *             for j in range(N):             # <<<<<<<<<<<<<<
 *                 C[i * N + j] += a_ik * B[k * N + j]
...
*/
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":33
 *             a_ik = A[i * K + k]
 *             for j in range(N):
 *                 C[i * N + j] += a_ik * B[k * N + j]             # <<<<<<<<<<<<<<
 * 
...
*/
        ...
        (__pyx_v_C[__pyx_t_10]) = ((__pyx_v_C[__pyx_t_10]) + (__pyx_v_a_ik * (__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));
      }
    }
  }
...
/* "cnake_charmer/engine/kernels/gemm_f32.pyx":36
 * 
 * 
...
static void __pyx_f_13cnake_charmer_6engine_7kernels_8gemm_f32_gemm_f32_avx(float const *__pyx_v_A, float const *__pyx_v_B, float *__pyx_v_C, int __pyx_v_M, int __pyx_v_N, int __pyx_v_K) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_nr;
  __m256 __pyx_v_vacc0;
  __m256 __pyx_v_vacc1;
  __m256 __pyx_v_vacc2;
  __m256 __pyx_v_vacc3;
  __m256 __pyx_v_va0;
  __m256 __pyx_v_va1;
  __m256 __pyx_v_va2;
  __m256 __pyx_v_va3;
  ...
  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":44
 *     """
 *     cdef int i, j, k
 *     cdef int nr = (N // 8) * 8             # <<<<<<<<<<<<<<
...
*/
  __pyx_v_nr = ((__pyx_v_N / 8) * 8);

  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":48
 *     cdef __m256 va0, va1, va2, va3, vb
 * 
 *     memset(C, 0, M * N * sizeof(float))             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":51
 * 
 *     # 4x8 tiled main loop
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=4) {
    ...
    /* "cnake_charmer/engine/kernels/gemm_f32.pyx":52
 *     # 4x8 tiled main loop
 *     for i in range(0, M - 3, 4):
 *         for j in range(0, nr, 8):             # <<<<<<<<<<<<<<
 *             vacc0 = _mm256_setzero_ps()
...
*/
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=8) {
      ...
      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":53
 *     for i in range(0, M - 3, 4):
 *         for j in range(0, nr, 8):
 *             vacc0 = _mm256_setzero_ps()             # <<<<<<<<<<<<<<
 *             vacc1 = _mm256_setzero_ps()
...
*/
      __pyx_v_vacc0 = _mm256_setzero_ps();

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":54
 *         for j in range(0, nr, 8):
 *             vacc0 = _mm256_setzero_ps()
 *             vacc1 = _mm256_setzero_ps()             # <<<<<<<<<<<<<<
 *             vacc2 = _mm256_setzero_ps()
...
*/
      __pyx_v_vacc1 = _mm256_setzero_ps();

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":55
 *             vacc0 = _mm256_setzero_ps()
 *             vacc1 = _mm256_setzero_ps()
 *             vacc2 = _mm256_setzero_ps()             # <<<<<<<<<<<<<<
 *             vacc3 = _mm256_setzero_ps()
 * 
*/
      __pyx_v_vacc2 = _mm256_setzero_ps();

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":56
 *             vacc1 = _mm256_setzero_ps()
 *             vacc2 = _mm256_setzero_ps()
 *             vacc3 = _mm256_setzero_ps()             # <<<<<<<<<<<<<<
 * 
 *             for k in range(K):
*/
      __pyx_v_vacc3 = _mm256_setzero_ps();

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":58
 *             vacc3 = _mm256_setzero_ps()
 * 
 *             for k in range(K):             # <<<<<<<<<<<<<<
...
*/
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":59
 * 
 *             for k in range(K):
 *                 va0 = _mm256_broadcast_ss(&A[(i + 0) * K + k])             # <<<<<<<<<<<<<<
 *                 va1 = _mm256_broadcast_ss(&A[(i + 1) * K + k])
...
*/
        __pyx_v_va0 = _mm256_broadcast_ss((&(__pyx_v_A[(((__pyx_v_i + 0) * __pyx_v_K) + __pyx_v_k)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":60
 *             for k in range(K):
 *                 va0 = _mm256_broadcast_ss(&A[(i + 0) * K + k])
 *                 va1 = _mm256_broadcast_ss(&A[(i + 1) * K + k])             # <<<<<<<<<<<<<<
 *                 va2 = _mm256_broadcast_ss(&A[(i + 2) * K + k])
...
*/
        __pyx_v_va1 = _mm256_broadcast_ss((&(__pyx_v_A[(((__pyx_v_i + 1) * __pyx_v_K) + __pyx_v_k)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":61
 *                 va0 = _mm256_broadcast_ss(&A[(i + 0) * K + k])
 *                 va1 = _mm256_broadcast_ss(&A[(i + 1) * K + k])
 *                 va2 = _mm256_broadcast_ss(&A[(i + 2) * K + k])             # <<<<<<<<<<<<<<
 *                 va3 = _mm256_broadcast_ss(&A[(i + 3) * K + k])
...
*/
        __pyx_v_va2 = _mm256_broadcast_ss((&(__pyx_v_A[(((__pyx_v_i + 2) * __pyx_v_K) + __pyx_v_k)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":62
 *                 va1 = _mm256_broadcast_ss(&A[(i + 1) * K + k])
 *                 va2 = _mm256_broadcast_ss(&A[(i + 2) * K + k])
 *                 va3 = _mm256_broadcast_ss(&A[(i + 3) * K + k])             # <<<<<<<<<<<<<<
 *                 vb = _mm256_loadu_ps(&B[k * N + j])
 * 
*/
        __pyx_v_va3 = _mm256_broadcast_ss((&(__pyx_v_A[(((__pyx_v_i + 3) * __pyx_v_K) + __pyx_v_k)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":63
 *                 va2 = _mm256_broadcast_ss(&A[(i + 2) * K + k])
 *                 va3 = _mm256_broadcast_ss(&A[(i + 3) * K + k])
 *                 vb = _mm256_loadu_ps(&B[k * N + j])             # <<<<<<<<<<<<<<
 * 
...
*/
        __pyx_v_vb = _mm256_loadu_ps((&(__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":65
 *                 vb = _mm256_loadu_ps(&B[k * N + j])
 * 
 *                 vacc0 = _mm256_fmadd_ps(va0, vb, vacc0)             # <<<<<<<<<<<<<<
...
*/
        __pyx_v_vacc0 = _mm256_fmadd_ps(__pyx_v_va0, __pyx_v_vb, __pyx_v_vacc0);

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":66
 * 
 *                 vacc0 = _mm256_fmadd_ps(va0, vb, vacc0)
 *                 vacc1 = _mm256_fmadd_ps(va1, vb, vacc1)             # <<<<<<<<<<<<<<
 *                 vacc2 = _mm256_fmadd_ps(va2, vb, vacc2)
...
*/
        __pyx_v_vacc1 = _mm256_fmadd_ps(__pyx_v_va1, __pyx_v_vb, __pyx_v_vacc1);

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":67
 *                 vacc0 = _mm256_fmadd_ps(va0, vb, vacc0)
 *                 vacc1 = _mm256_fmadd_ps(va1, vb, vacc1)
 *                 vacc2 = _mm256_fmadd_ps(va2, vb, vacc2)             # <<<<<<<<<<<<<<
 *                 vacc3 = _mm256_fmadd_ps(va3, vb, vacc3)
 * 
*/
        __pyx_v_vacc2 = _mm256_fmadd_ps(__pyx_v_va2, __pyx_v_vb, __pyx_v_vacc2);

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":68
 *                 vacc1 = _mm256_fmadd_ps(va1, vb, vacc1)
 *                 vacc2 = _mm256_fmadd_ps(va2, vb, vacc2)
 *                 vacc3 = _mm256_fmadd_ps(va3, vb, vacc3)             # <<<<<<<<<<<<<<
 * 
...
*/
        __pyx_v_vacc3 = _mm256_fmadd_ps(__pyx_v_va3, __pyx_v_vb, __pyx_v_vacc3);
      }

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":71
 * 
 *             # Store tile (add to C in case of accumulation)
...
*/
      _mm256_storeu_ps((&(__pyx_v_C[(((__pyx_v_i + 0) * __pyx_v_N) + __pyx_v_j)])), _mm256_add_ps(_mm256_loadu_ps((&(__pyx_v_C[(((__pyx_v_i + 0) * __pyx_v_N) + __pyx_v_j)]))), __pyx_v_vacc0));

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":73
 *             _mm256_storeu_ps(&C[(i + 0) * N + j],
 *                              _mm256_add_ps(_mm256_loadu_ps(&C[(i + 0) * N + j]), vacc0))
 *             _mm256_storeu_ps(&C[(i + 1) * N + j],             # <<<<<<<<<<<<<<
...
*/
      _mm256_storeu_ps((&(__pyx_v_C[(((__pyx_v_i + 1) * __pyx_v_N) + __pyx_v_j)])), _mm256_add_ps(_mm256_loadu_ps((&(__pyx_v_C[(((__pyx_v_i + 1) * __pyx_v_N) + __pyx_v_j)]))), __pyx_v_vacc1));

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":75
 *             _mm256_storeu_ps(&C[(i + 1) * N + j],
 *                              _mm256_add_ps(_mm256_loadu_ps(&C[(i + 1) * N + j]), vacc1))
 *             _mm256_storeu_ps(&C[(i + 2) * N + j],             # <<<<<<<<<<<<<<
...
*/
      _mm256_storeu_ps((&(__pyx_v_C[(((__pyx_v_i + 2) * __pyx_v_N) + __pyx_v_j)])), _mm256_add_ps(_mm256_loadu_ps((&(__pyx_v_C[(((__pyx_v_i + 2) * __pyx_v_N) + __pyx_v_j)]))), __pyx_v_vacc2));

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":77
 *             _mm256_storeu_ps(&C[(i + 2) * N + j],
 *                              _mm256_add_ps(_mm256_loadu_ps(&C[(i + 2) * N + j]), vacc2))
 *             _mm256_storeu_ps(&C[(i + 3) * N + j],             # <<<<<<<<<<<<<<
 ...
 * 
*/
      _mm256_storeu_ps((&(__pyx_v_C[(((__pyx_v_i + 3) * __pyx_v_N) + __pyx_v_j)])), _mm256_add_ps(_mm256_loadu_ps((&(__pyx_v_C[(((__pyx_v_i + 3) * __pyx_v_N) + __pyx_v_j)]))), __pyx_v_vacc3));
    }

    /* "cnake_charmer/engine/kernels/gemm_f32.pyx":81
 * 
...
*/
    __pyx_t_4 = __pyx_v_N;
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = __pyx_v_nr; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":82
 *         # Remainder columns (scalar)
 *         for j in range(nr, N):
 *             for k in range(K):             # <<<<<<<<<<<<<<
 *                 C[(i + 0) * N + j] += A[(i + 0) * K + k] * B[k * N + j]
...
*/
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":83
 *         for j in range(nr, N):
 *             for k in range(K):
 *                 C[(i + 0) * N + j] += A[(i + 0) * K + k] * B[k * N + j]             # <<<<<<<<<<<<<<
 *                 C[(i + 1) * N + j] += A[(i + 1) * K + k] * B[k * N + j]
...
*/
        __pyx_t_10 = (((__pyx_v_i + 0) * __pyx_v_N) + __pyx_v_j);
        (__pyx_v_C[__pyx_t_10]) = ((__pyx_v_C[__pyx_t_10]) + ((__pyx_v_A[(((__pyx_v_i + 0) * __pyx_v_K) + __pyx_v_k)]) * (__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":84
 *             for k in range(K):
 *                 C[(i + 0) * N + j] += A[(i + 0) * K + k] * B[k * N + j]
 *                 C[(i + 1) * N + j] += A[(i + 1) * K + k] * B[k * N + j]             # <<<<<<<<<<<<<<
 *                 C[(i + 2) * N + j] += A[(i + 2) * K + k] * B[k * N + j]
...
*/
        __pyx_t_10 = (((__pyx_v_i + 1) * __pyx_v_N) + __pyx_v_j);
        (__pyx_v_C[__pyx_t_10]) = ((__pyx_v_C[__pyx_t_10]) + ((__pyx_v_A[(((__pyx_v_i + 1) * __pyx_v_K) + __pyx_v_k)]) * (__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":85
 *                 C[(i + 0) * N + j] += A[(i + 0) * K + k] * B[k * N + j]
 *                 C[(i + 1) * N + j] += A[(i + 1) * K + k] * B[k * N + j]
 *                 C[(i + 2) * N + j] += A[(i + 2) * K + k] * B[k * N + j]             # <<<<<<<<<<<<<<
 *                 C[(i + 3) * N + j] += A[(i + 3) * K + k] * B[k * N + j]
 * 
*/
        __pyx_t_10 = (((__pyx_v_i + 2) * __pyx_v_N) + __pyx_v_j);
        (__pyx_v_C[__pyx_t_10]) = ((__pyx_v_C[__pyx_t_10]) + ((__pyx_v_A[(((__pyx_v_i + 2) * __pyx_v_K) + __pyx_v_k)]) * (__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));

        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":86
 *                 C[(i + 1) * N + j] += A[(i + 1) * K + k] * B[k * N + j]
 *                 C[(i + 2) * N + j] += A[(i + 2) * K + k] * B[k * N + j]
 *                 C[(i + 3) * N + j] += A[(i + 3) * K + k] * B[k * N + j]             # <<<<<<<<<<<<<<
 * 
...
*/
        __pyx_t_10 = (((__pyx_v_i + 3) * __pyx_v_N) + __pyx_v_j);
        (__pyx_v_C[__pyx_t_10]) = ((__pyx_v_C[__pyx_t_10]) + ((__pyx_v_A[(((__pyx_v_i + 3) * __pyx_v_K) + __pyx_v_k)]) * (__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));
      }
    }
  }

  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":89
 * 
 *     # Remainder rows (scalar)
...
*/
  __pyx_t_3 = __pyx_v_M;
  __pyx_t_4 = __pyx_t_3;
  for (__pyx_t_5 = ((__pyx_v_M / 4) * 4); __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    __pyx_v_i = __pyx_t_5;

    /* "cnake_charmer/engine/kernels/gemm_f32.pyx":90
 *     # Remainder rows (scalar)
 *     for i in range((M // 4) * 4, M):
 *         for k in range(K):             # <<<<<<<<<<<<<<
 *             for j in range(N):
...
*/
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      ...
      /* "cnake_charmer/engine/kernels/gemm_f32.pyx":91
 *     for i in range((M // 4) * 4, M):
 *         for k in range(K):
 *             for j in range(N):             # <<<<<<<<<<<<<<
 *                 C[i * N + j] += A[i * K + k] * B[k * N + j]
*/
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        ...
        /* "cnake_charmer/engine/kernels/gemm_f32.pyx":92
 *         for k in range(K):
 *             for j in range(N):
 *                 C[i * N + j] += A[i * K + k] * B[k * N + j]             # <<<<<<<<<<<<<<
*/
        __pyx_t_13 = ((__pyx_v_i * __pyx_v_N) + __pyx_v_j);
        (__pyx_v_C[__pyx_t_13]) = ((__pyx_v_C[__pyx_t_13]) + ((__pyx_v_A[((__pyx_v_i * __pyx_v_K) + __pyx_v_k)]) * (__pyx_v_B[((__pyx_v_k * __pyx_v_N) + __pyx_v_j)])));
      }
    }
  }
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    const char * __pyx_export_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_void_float_const_float_const_flo);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_export_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 61;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_13cnake_charmer_6engine_7kernels_8gemm_f32_gemm_f32, (void (*)(void))&__pyx_f_13cnake_charmer_6engine_7kernels_8gemm_f32_gemm_f32_avx, (void (*)(void)) NULL};
...
static int __pyx_pymod_exec_gemm_f32(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_gemm_f32},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "gemm_f32",
      __pyx_k_GEMM_f32_kernels_scalar_and_XNNP, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_gemm_f32(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_gemm_f32(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_gemm_f32(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'gemm_f32' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "gemm_f32" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_gemm_f32", 0);
  ...
  if (__pyx_module_is_main_cnake_charmer__engine__kernels__gemm_f32) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cnake_charmer.engine.kernels.gemm_f32")) {
      if (unlikely((PyDict_SetItemString(modules, "cnake_charmer.engine.kernels.gemm_f32", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "cnake_charmer/engine/kernels/gemm_f32.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cnake_charmer.engine.kernels.gemm_f32", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cnake_charmer.engine.kernels.gemm_f32");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{18},{8},{10},{8},{12},{12},{10},{8},{82}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (152 bytes) */
const char* const cstring = "BZh91AY&SY\310\224X\303\000\000\020[\200@\000@t\030\000\200\000\277\257\377` \000\225CQ\017S\322\031\250\323\324\032z\215\001(\232Sz\032\246\214L\232\031=C.\025\014xB\250<\225*H[\031\027\240&\372\032\355*\230\276\344\350\224^6*\220\345\234\220\301\364\024Q= \322\021\217\014\016\262\t\021\333\017\022g\231\272J\362W6c\314\352F\202\332P*I\036\360Q\314\255\340\214\314\021\222\315>\205\365vX\374\277\213\271\"\234(HdJ,a\200";
...
const char* const cstring = "x\332m\210A\016\3020\014\004\373\224\034\001q\202\007\364)\226q\034\024\325v\nq\252\366\367\244 \301\205=\314\316\356H\222\215!\033\370\023\211oH\023\200b\337=Zb\023\336\315P\337=o+\020\316y\367GC\371\374\225=r\302&\016\340\\;\227\222c8$)\350\201\212U\017\247s\370;\273d\363\037\216\303pgUH\327\313W\000\227\365\005s\222=R";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (169 bytes) */
const char* const bytes = "?cline_in_traceback__main____module____name____pyx_capi____qualname__setdefault__test__void (float const *, float const *, float *, int, int, int)\000\000gemm_f32\000gemm_f32_avx";
    PyObject *data = NULL;
