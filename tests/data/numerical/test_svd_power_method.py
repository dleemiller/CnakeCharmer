...
from cnake_data.cy.numerical.svd_power_method import svd_power_method as cy_func
from cnake_data.py.numerical.svd_power_method import svd_power_method as py_func
