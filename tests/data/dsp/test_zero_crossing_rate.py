...
from cnake_data.cy.dsp.zero_crossing_rate import zero_crossing_rate as cy_zero_crossing_rate
from cnake_data.py.dsp.zero_crossing_rate import zero_crossing_rate as py_zero_crossing_rate
