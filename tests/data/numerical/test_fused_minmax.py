...
from cnake_data.cy.numerical.fused_minmax import fused_minmax as cy_fused_minmax
from cnake_data.py.numerical.fused_minmax import fused_minmax as py_fused_minmax
