...
from cnake_charmer.cy.statistics.bicluster_scs_score import bicluster_scs_score as cy_func
from cnake_charmer.py.statistics.bicluster_scs_score import bicluster_scs_score as py_func
