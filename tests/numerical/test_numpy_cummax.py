...
from cnake_charmer.cy.numerical.numpy_cummax import numpy_cummax as cy_func
from cnake_charmer.py.numerical.numpy_cummax import numpy_cummax as py_func
