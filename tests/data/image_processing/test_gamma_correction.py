...
from cnake_data.cy.image_processing.gamma_correction import gamma_correction as cy_func
from cnake_data.py.image_processing.gamma_correction import gamma_correction as py_func
