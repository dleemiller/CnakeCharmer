...
from cnake_data.cy.simulation.random_walk_2d import random_walk_2d as cy_random_walk_2d
from cnake_data.py.simulation.random_walk_2d import random_walk_2d as py_random_walk_2d
