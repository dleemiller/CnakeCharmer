...
from cnake_charmer.cy.numerical.fused_clamp import fused_clamp as cy_fused_clamp
from cnake_charmer.py.numerical.fused_clamp import fused_clamp as py_fused_clamp
