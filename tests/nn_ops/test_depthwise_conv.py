...
from cnake_charmer.cy.nn_ops.depthwise_conv import depthwise_conv as cy_func
from cnake_charmer.py.nn_ops.depthwise_conv import depthwise_conv as py_func
