...
from cnake_charmer.cy.numerical.except_check_sqrt import except_check_sqrt as cy_except_check_sqrt
from cnake_charmer.py.numerical.except_check_sqrt import except_check_sqrt as py_except_check_sqrt
