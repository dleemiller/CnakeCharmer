...
from cnake_data.cy.numerical.runge_kutta import runge_kutta as cy_runge_kutta
from cnake_data.py.numerical.runge_kutta import runge_kutta as py_runge_kutta
