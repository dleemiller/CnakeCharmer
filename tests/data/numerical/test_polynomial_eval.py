...
from cnake_data.cy.numerical.polynomial_eval import polynomial_eval as cy_polynomial_eval
from cnake_data.py.numerical.polynomial_eval import polynomial_eval as py_polynomial_eval
