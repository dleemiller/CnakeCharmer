...
from cnake_charmer.cy.geometry.polygon_centroid import polygon_centroid as cy_func
from cnake_charmer.py.geometry.polygon_centroid import polygon_centroid as py_func
