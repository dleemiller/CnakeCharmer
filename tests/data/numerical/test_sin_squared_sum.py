...
from cnake_data.cy.numerical.sin_squared_sum import sin_squared_sum as cy_func
from cnake_data.py.numerical.sin_squared_sum import sin_squared_sum as py_func
