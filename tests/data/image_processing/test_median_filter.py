...
from cnake_data.cy.image_processing.median_filter import median_filter as cy_func
from cnake_data.py.image_processing.median_filter import median_filter as py_func
