...
from cnake_charmer.cy.optimization.simulated_annealing_deterministic import (
    simulated_annealing_deterministic as cy_func,
)
from cnake_charmer.py.optimization.simulated_annealing_deterministic import (
