...
from cnake_charmer.cy.numerical.ctuple_minmax import ctuple_minmax as cy_func
from cnake_charmer.py.numerical.ctuple_minmax import ctuple_minmax as py_func
