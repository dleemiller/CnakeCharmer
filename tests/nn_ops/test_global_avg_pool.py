...
from cnake_charmer.cy.nn_ops.global_avg_pool import global_avg_pool as cy_func
from cnake_charmer.py.nn_ops.global_avg_pool import global_avg_pool as py_func
