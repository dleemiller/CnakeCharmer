...
from cnake_data.cy.physics.relativistic_energy import relativistic_energy as cy_func
from cnake_data.py.physics.relativistic_energy import relativistic_energy as py_func
