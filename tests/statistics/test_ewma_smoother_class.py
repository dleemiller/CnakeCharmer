...
from cnake_charmer.cy.statistics.ewma_smoother_class import ewma_smoother_class as cy_func
from cnake_charmer.py.statistics.ewma_smoother_class import ewma_smoother_class as py_func
