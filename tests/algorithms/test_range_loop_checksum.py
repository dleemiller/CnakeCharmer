...
from cnake_charmer.cy.algorithms.range_loop_checksum import range_loop_checksum as cy_func
from cnake_charmer.py.algorithms.range_loop_checksum import range_loop_checksum as py_func
