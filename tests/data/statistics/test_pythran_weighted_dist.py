...
from cnake_data.cy.statistics.pythran_weighted_dist import pythran_weighted_dist as cy_func
from cnake_data.py.statistics.pythran_weighted_dist import pythran_weighted_dist as py_func
