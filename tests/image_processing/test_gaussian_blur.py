...
from cnake_charmer.cy.image_processing.gaussian_blur import gaussian_blur as cy_func
from cnake_charmer.py.image_processing.gaussian_blur import gaussian_blur as py_func
