...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cnake_charmer.engine.kernels.relu_f32",
        "sources": [
            "cnake_charmer/engine/kernels/relu_f32.pyx"
        ]
    },
    "module_name": "cnake_charmer.engine.kernels.relu_f32"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cnake_charmer__engine__kernels__relu_f32
#define __PYX_HAVE_API__cnake_charmer__engine__kernels__relu_f32
/* Early includes */
#include "immintrin.h"
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "cnake_charmer.engine.kernels.relu_f32" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cnake_charmer.engine.kernels.relu_f32"
extern int __pyx_module_is_main_cnake_charmer__engine__kernels__relu_f32;
int __pyx_module_is_main_cnake_charmer__engine__kernels__relu_f32 = 0;

/* Implementation of "cnake_charmer.engine.kernels.relu_f32" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_ReLU_f32_kernels_scalar_and_AVX2[] = "ReLU f32 kernels \342\200\224 scalar and AVX2 implementations.\n\nPure compute, no allocation. Can be cimported by benchmark wrappers\nor a future inference engine.\n";
/* #### Code section: decls ### */
...
#define __pyx_kp_b_double_float_const_int_void_floa __pyx_string_tab[9]
...
/* "cnake_charmer/engine/kernels/relu_f32.pyx":17
 * 
 * 
...
static void __pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_relu_f32(float const *__pyx_v_inp, float *__pyx_v_out, int __pyx_v_n) {
  int __pyx_v_i;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":20
 *     """Scalar ReLU: out[i] = max(0, inp[i]). Supports in-place (inp == out)."""
 *     cdef int i
 *     for i in range(n):             # <<<<<<<<<<<<<<
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":21
 *     cdef int i
 *     for i in range(n):
 *         out[i] = inp[i] if inp[i] > 0.0 else 0.0             # <<<<<<<<<<<<<<
 * 
 * 
*/
    __pyx_t_5 = ((__pyx_v_inp[__pyx_v_i]) > 0.0);
    if (__pyx_t_5) {
      __pyx_t_4 = (__pyx_v_inp[__pyx_v_i]);
    } else {
      __pyx_t_4 = 0.0;
    }
...
/* "cnake_charmer/engine/kernels/relu_f32.pyx":24
 * 
 * 
...
static void __pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_relu_f32_avx(float const *__pyx_v_inp, float *__pyx_v_out, int __pyx_v_n) {
  __m256 __pyx_v_vzero;
  __m256 __pyx_v_v0;
  __m256 __pyx_v_v1;
  int __pyx_v_i;
  int __pyx_v_end16;
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":26
 * cdef void relu_f32_avx(const float *inp, float *out, int n) noexcept nogil:
 *     """AVX2 ReLU: XNNPACK vclamp pattern, 16 floats per iteration."""
 *     cdef __m256 vzero = _mm256_setzero_ps()             # <<<<<<<<<<<<<<
 *     cdef __m256 v0, v1
 *     cdef int i
*/
  __pyx_v_vzero = _mm256_setzero_ps();

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":29
 *     cdef __m256 v0, v1
 *     cdef int i
 ...
 * 
*/
  __pyx_v_end16 = ((__pyx_v_n / 16) * 16);

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":30
 *     cdef int i
 *     cdef int end16 = (n // 16) * 16
 *     cdef int end8 = (n // 8) * 8             # <<<<<<<<<<<<<<
 * 
...
*/
  __pyx_v_end8 = ((__pyx_v_n / 8) * 8);

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":33
 * 
 *     # Main loop: 16 per iteration
...
*/
  __pyx_t_1 = __pyx_v_end16;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=16) {
    __pyx_v_i = __pyx_t_3;

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":34
 *     # Main loop: 16 per iteration
 *     for i in range(0, end16, 16):
 *         v0 = _mm256_loadu_ps(&inp[i])             # <<<<<<<<<<<<<<
 *         v1 = _mm256_loadu_ps(&inp[i + 8])
...
*/
    __pyx_v_v0 = _mm256_loadu_ps((&(__pyx_v_inp[__pyx_v_i])));

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":35
 *     for i in range(0, end16, 16):
 *         v0 = _mm256_loadu_ps(&inp[i])
 *         v1 = _mm256_loadu_ps(&inp[i + 8])             # <<<<<<<<<<<<<<
 *         v0 = _mm256_max_ps(vzero, v0)
...
*/
    __pyx_v_v1 = _mm256_loadu_ps((&(__pyx_v_inp[(__pyx_v_i + 8)])));

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":36
 *         v0 = _mm256_loadu_ps(&inp[i])
 *         v1 = _mm256_loadu_ps(&inp[i + 8])
 *         v0 = _mm256_max_ps(vzero, v0)             # <<<<<<<<<<<<<<
 *         v1 = _mm256_max_ps(vzero, v1)
...
*/
    __pyx_v_v0 = _mm256_max_ps(__pyx_v_vzero, __pyx_v_v0);

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":37
 *         v1 = _mm256_loadu_ps(&inp[i + 8])
 *         v0 = _mm256_max_ps(vzero, v0)
 *         v1 = _mm256_max_ps(vzero, v1)             # <<<<<<<<<<<<<<
 *         _mm256_storeu_ps(&out[i], v0)
...
*/
    __pyx_v_v1 = _mm256_max_ps(__pyx_v_vzero, __pyx_v_v1);

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":38
 *         v0 = _mm256_max_ps(vzero, v0)
 *         v1 = _mm256_max_ps(vzero, v1)
 *         _mm256_storeu_ps(&out[i], v0)             # <<<<<<<<<<<<<<
 *         _mm256_storeu_ps(&out[i + 8], v1)
 * 
*/
    _mm256_storeu_ps((&(__pyx_v_out[__pyx_v_i])), __pyx_v_v0);

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":39
 *         v1 = _mm256_max_ps(vzero, v1)
 *         _mm256_storeu_ps(&out[i], v0)
 *         _mm256_storeu_ps(&out[i + 8], v1)             # <<<<<<<<<<<<<<
 * 
 *     # 8-wide remainder
*/
    _mm256_storeu_ps((&(__pyx_v_out[(__pyx_v_i + 8)])), __pyx_v_v1);
  }

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":42
 * 
 *     # 8-wide remainder
 ...
 *         v0 = _mm256_max_ps(vzero, v0)
*/
  __pyx_t_1 = __pyx_v_end8;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = __pyx_v_end16; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=8) {
    __pyx_v_i = __pyx_t_3;

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":43
 *     # 8-wide remainder
 *     for i in range(end16, end8, 8):
 *         v0 = _mm256_loadu_ps(&inp[i])             # <<<<<<<<<<<<<<
 *         v0 = _mm256_max_ps(vzero, v0)
...
*/
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":44
 *     for i in range(end16, end8, 8):
 *         v0 = _mm256_loadu_ps(&inp[i])
 *         v0 = _mm256_max_ps(vzero, v0)             # <<<<<<<<<<<<<<
 *         _mm256_storeu_ps(&out[i], v0)
...
*/
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":45
 *         v0 = _mm256_loadu_ps(&inp[i])
 *         v0 = _mm256_max_ps(vzero, v0)
 *         _mm256_storeu_ps(&out[i], v0)             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":48
 * 
 *     # Scalar remainder
...
*/
  __pyx_t_1 = __pyx_v_n;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = __pyx_v_end8; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "cnake_charmer/engine/kernels/relu_f32.pyx":49
 *     # Scalar remainder
 *     for i in range(end8, n):
 *         out[i] = inp[i] if inp[i] > 0.0 else 0.0             # <<<<<<<<<<<<<<
 * 
...
/* "cnake_charmer/engine/kernels/relu_f32.pyx":52
 * 
 * 
...
static double __pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_reduce_sum_f32(float const *__pyx_v_data, int __pyx_v_n) {
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":54
 * cdef double reduce_sum_f32(const float *data, int n) noexcept nogil:
 *     """Scalar sum reduction."""
 *     cdef double total = 0.0             # <<<<<<<<<<<<<<
 *     cdef int i
...
*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":56
 *     cdef double total = 0.0
 *     cdef int i
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         total += data[i]
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":57
 *     cdef int i
 *     for i in range(n):
 *         total += data[i]             # <<<<<<<<<<<<<<
 *     return total
...
*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":58
 *     for i in range(n):
 *         total += data[i]
 *     return total             # <<<<<<<<<<<<<<
 * 
...
/* "cnake_charmer/engine/kernels/relu_f32.pyx":61
 * 
 * 
...
static double __pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_reduce_sum_f32_avx(float const *__pyx_v_data, int __pyx_v_n) {
  __m256 __pyx_v_acc;
  int __pyx_v_i;
  int __pyx_v_end8;
  float __pyx_v_tmp[8];
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":63
 * cdef double reduce_sum_f32_avx(const float *data, int n) noexcept nogil:
 *     """AVX2 sum reduction: 8-wide accumulate."""
 *     cdef __m256 acc = _mm256_setzero_ps()             # <<<<<<<<<<<<<<
 *     cdef int i
 *     cdef int end8 = (n // 8) * 8
*/
  __pyx_v_acc = _mm256_setzero_ps();

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":65
 *     cdef __m256 acc = _mm256_setzero_ps()
 *     cdef int i
 *     cdef int end8 = (n // 8) * 8             # <<<<<<<<<<<<<<
 *     cdef float tmp[8]
...
*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":67
 *     cdef int end8 = (n // 8) * 8
 *     cdef float tmp[8]
 *     cdef double total = 0.0             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":69
 *     cdef double total = 0.0
 * 
 *     for i in range(0, end8, 8):             # <<<<<<<<<<<<<<
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=8) {
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":70
 * 
 *     for i in range(0, end8, 8):
 *         acc = _mm256_add_ps(acc, _mm256_loadu_ps(&data[i]))             # <<<<<<<<<<<<<<
 * 
...
*/
    __pyx_v_acc = _mm256_add_ps(__pyx_v_acc, _mm256_loadu_ps((&(__pyx_v_data[__pyx_v_i]))));
  }

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":72
 *         acc = _mm256_add_ps(acc, _mm256_loadu_ps(&data[i]))
 * 
 *     _mm256_storeu_ps(tmp, acc)             # <<<<<<<<<<<<<<
 *     for i in range(8):
 *         total += tmp[i]
*/
  _mm256_storeu_ps(__pyx_v_tmp, __pyx_v_acc);

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":73
 * 
 *     _mm256_storeu_ps(tmp, acc)
 *     for i in range(8):             # <<<<<<<<<<<<<<
 *         total += tmp[i]
...
*/
  for (__pyx_t_1 = 0; __pyx_t_1 < 8; __pyx_t_1+=1) {
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":74
 *     _mm256_storeu_ps(tmp, acc)
 *     for i in range(8):
 *         total += tmp[i]             # <<<<<<<<<<<<<<
 *     for i in range(end8, n):
 *         total += data[i]
*/
    __pyx_v_total = (__pyx_v_total + (__pyx_v_tmp[__pyx_v_i]));
  }

  /* "cnake_charmer/engine/kernels/relu_f32.pyx":75
 *     for i in range(8):
 *         total += tmp[i]
 *     for i in range(end8, n):             # <<<<<<<<<<<<<<
 *         total += data[i]
...
*/
  ...
  for (__pyx_t_3 = __pyx_v_end8; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "cnake_charmer/engine/kernels/relu_f32.pyx":76
 *         total += tmp[i]
 *     for i in range(end8, n):
 *         total += data[i]             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":78
 *         total += data[i]
 * 
 *     return total             # <<<<<<<<<<<<<<
*/
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    const char * __pyx_export_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_double_float_const_int_void_floa);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_export_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 65;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_reduce_sum_f32, (void (*)(void))&__pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_reduce_sum_f32_avx, (void (*)(void))&__pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_relu_f32, (void (*)(void))&__pyx_f_13cnake_charmer_6engine_7kernels_8relu_f32_relu_f32_avx, (void (*)(void)) NULL};
...
static int __pyx_pymod_exec_relu_f32(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_relu_f32},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "relu_f32",
      __pyx_k_ReLU_f32_kernels_scalar_and_AVX2, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit_relu_f32(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_relu_f32(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_relu_f32(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'relu_f32' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "relu_f32" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_relu_f32", 0);
  ...
  if (__pyx_module_is_main_cnake_charmer__engine__kernels__relu_f32) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cnake_charmer.engine.kernels.relu_f32")) {
      if (unlikely((PyDict_SetItemString(modules, "cnake_charmer.engine.kernels.relu_f32", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "cnake_charmer/engine/kernels/relu_f32.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cnake_charmer.engine.kernels.relu_f32", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cnake_charmer.engine.kernels.relu_f32");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{18},{8},{10},{8},{12},{12},{10},{8},{120}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (169 bytes) */
const char* const cstring = "BZh91AY&SY\002[\357\351\000\000\023\333\200@\000@t\030\000\200\000\277/\377` \000\224\204\251\352D\375S\302h'\352\2150\214\022\205'\251\352~\210\324\323d\000\232\341\301\243\332\265>\362\204\321\306\025&\227\207\340\224\3014r\257k\232\204c\247I5\302\024\371\325\232\363\356\360\306D\332(\330\331\3153o$\367,Z\320\310\325\023\375@\246\034\034\3336\305\214\037\324Y\341uDJ\363\207\025#Q\021\203\377\250\362\221\222\204\254`\305}\252\236\206\234 1\335$\237\";\027\237\355\340\273\222)\302\204\200\022\337\177H";
    PyObject *data = __Pyx_DecompressString(cstring, 169, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (131 bytes) */
const char* const cstring = "x\332e\212A\016\0021\010E\347(]\252q\245\007\360(\204\2414i\244\3558\205\311x{[k\\(\013x\357\177n$13\304\014\272\"\361\214t\007H\330\274M*\336\204;eL\357\273<w \\b\347\207\241\214\274\262z\016h\242\000\312\265m_l\026v\207 \005\325Q\311U\335\351\354b\326\3434m%\372\277j\350\367geo\304P-A\270^~\024p\333[$\366\351\006\364\364\005\227\337J\331";
    PyObject *data = __Pyx_DecompressString(cstring, 131, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (207 bytes) */
const char* const bytes = "?cline_in_traceback__main____module____name____pyx_capi____qualname__setdefault__test__double (float const *, int)\000\000void (float const *, float *, int)\000\000reduce_sum_f32\000reduce_sum_f32_avx\000relu_f32\000relu_f32_avx";
    PyObject *data = NULL;
