...
from cnake_data.cy.numerical.range_iterator_sum import range_iterator_sum as cy_func
from cnake_data.py.numerical.range_iterator_sum import range_iterator_sum as py_func
