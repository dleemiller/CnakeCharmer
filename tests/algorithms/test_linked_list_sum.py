...
from cnake_charmer.cy.algorithms.linked_list_sum import linked_list_sum as cy_func
from cnake_charmer.py.algorithms.linked_list_sum import linked_list_sum as py_func
