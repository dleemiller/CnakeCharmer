...
from cnake_charmer.cy.algorithms.sudoku_solver import sudoku_solver as cy_sudoku_solver
from cnake_charmer.py.algorithms.sudoku_solver import sudoku_solver as py_sudoku_solver
