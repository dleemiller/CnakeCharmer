...
from cnake_charmer.cy.numerical.lerp_accumulate import lerp_accumulate as cy_func
from cnake_charmer.py.numerical.lerp_accumulate import lerp_accumulate as py_func
