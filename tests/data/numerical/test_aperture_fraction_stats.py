...
from cnake_data.cy.numerical.aperture_fraction_stats import aperture_fraction_stats as cy_func
from cnake_data.py.numerical.aperture_fraction_stats import aperture_fraction_stats as py_func
