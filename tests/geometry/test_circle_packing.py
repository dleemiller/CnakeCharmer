...
from cnake_charmer.cy.geometry.circle_packing import circle_packing as cy_func
from cnake_charmer.py.geometry.circle_packing import circle_packing as py_func
