...
from cnake_charmer.cy.numerical.ufunc_smoothstep import ufunc_smoothstep as cy_func
from cnake_charmer.py.numerical.ufunc_smoothstep import ufunc_smoothstep as py_func
