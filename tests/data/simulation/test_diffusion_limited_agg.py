...
from cnake_data.cy.simulation.diffusion_limited_agg import diffusion_limited_agg as cy_func
from cnake_data.py.simulation.diffusion_limited_agg import diffusion_limited_agg as py_func
