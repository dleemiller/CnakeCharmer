...
from cnake_data.cy.image_processing.otsu_threshold import otsu_threshold as cy_func
from cnake_data.py.image_processing.otsu_threshold import otsu_threshold as py_func
