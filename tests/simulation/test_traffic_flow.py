...
from cnake_charmer.cy.simulation.traffic_flow import traffic_flow as cy_func
from cnake_charmer.py.simulation.traffic_flow import traffic_flow as py_func
