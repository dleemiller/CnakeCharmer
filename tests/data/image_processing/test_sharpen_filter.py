...
from cnake_data.cy.image_processing.sharpen_filter import sharpen_filter as cy_func
from cnake_data.py.image_processing.sharpen_filter import sharpen_filter as py_func
