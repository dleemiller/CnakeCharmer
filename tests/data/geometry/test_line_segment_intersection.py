...
from cnake_data.cy.geometry.line_segment_intersection import line_segment_intersection as cy_func
from cnake_data.py.geometry.line_segment_intersection import line_segment_intersection as py_func
