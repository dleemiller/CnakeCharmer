...
from cnake_data.cy.algorithms.eggs_affine_iterate import eggs_affine_iterate as cy_func
from cnake_data.py.algorithms.eggs_affine_iterate import eggs_affine_iterate as py_func
