...
from cnake_data.cy.image_processing.sobel_edge import sobel_edge as cy_sobel_edge
from cnake_data.py.image_processing.sobel_edge import sobel_edge as py_sobel_edge
