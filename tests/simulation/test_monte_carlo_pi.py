...
from cnake_charmer.cy.simulation.monte_carlo_pi import monte_carlo_pi as cy_func
from cnake_charmer.py.simulation.monte_carlo_pi import monte_carlo_pi as py_func
