...
from cnake_charmer.cy.geometry.vector3d_cross_sum import vector3d_cross_sum as cy_func
from cnake_charmer.py.geometry.vector3d_cross_sum import vector3d_cross_sum as py_func
