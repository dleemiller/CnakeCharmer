...
from cnake_data.cy.math_problems.euclidean_gcd_sum import euclidean_gcd_sum as cy_func
from cnake_data.py.math_problems.euclidean_gcd_sum import euclidean_gcd_sum as py_func
