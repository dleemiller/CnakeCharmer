...
from cnake_charmer.cy.math_problems.count_primes_trial import count_primes_trial as cy_func
from cnake_charmer.py.math_problems.count_primes_trial import count_primes_trial as py_func
