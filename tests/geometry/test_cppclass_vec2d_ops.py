...
from cnake_charmer.cy.geometry.cppclass_vec2d_ops import cppclass_vec2d_ops as cy_func
from cnake_charmer.py.geometry.cppclass_vec2d_ops import cppclass_vec2d_ops as py_func
