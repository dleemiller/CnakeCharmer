...
from cnake_charmer.cy.algorithms.xorshift_randint_sum import xorshift_randint_sum as cy_func
from cnake_charmer.py.algorithms.xorshift_randint_sum import xorshift_randint_sum as py_func
