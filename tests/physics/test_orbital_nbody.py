...
from cnake_charmer.cy.physics.orbital_nbody import orbital_nbody as cy_func
from cnake_charmer.py.physics.orbital_nbody import orbital_nbody as py_func
