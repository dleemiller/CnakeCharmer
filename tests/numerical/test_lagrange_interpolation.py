...
from cnake_charmer.cy.numerical.lagrange_interpolation import lagrange_interpolation as cy_func
from cnake_charmer.py.numerical.lagrange_interpolation import lagrange_interpolation as py_func
