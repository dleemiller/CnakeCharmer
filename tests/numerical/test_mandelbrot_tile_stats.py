...
from cnake_charmer.cy.numerical.mandelbrot_tile_stats import mandelbrot_tile_stats as cy_func
from cnake_charmer.py.numerical.mandelbrot_tile_stats import mandelbrot_tile_stats as py_func
