...
from cnake_charmer.cy.numerical.newton_sqrt import newton_sqrt as cy_newton_sqrt
from cnake_charmer.py.numerical.newton_sqrt import newton_sqrt as py_newton_sqrt
