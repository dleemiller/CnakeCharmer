...
from cnake_data.cy.statistics.poisson_pmf_sum import poisson_pmf_sum as cy_func
from cnake_data.py.statistics.poisson_pmf_sum import poisson_pmf_sum as py_func
