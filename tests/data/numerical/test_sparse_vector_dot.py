...
from cnake_data.cy.numerical.sparse_vector_dot import sparse_vector_dot as cy_func
from cnake_data.py.numerical.sparse_vector_dot import sparse_vector_dot as py_func
