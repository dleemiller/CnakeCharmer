...
from cnake_data.cy.simulation.doom_fire_lineage_class import doom_fire_lineage_class as cy_func
from cnake_data.py.simulation.doom_fire_lineage_class import doom_fire_lineage_class as py_func
