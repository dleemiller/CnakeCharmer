...
from cnake_charmer.cy.compression.png_filters import png_filters as cy_func
from cnake_charmer.py.compression.png_filters import png_filters as py_func
