...
from cnake_charmer.cy.numerical.great_circle import great_circle as cy_great_circle
from cnake_charmer.py.numerical.great_circle import great_circle as py_great_circle
