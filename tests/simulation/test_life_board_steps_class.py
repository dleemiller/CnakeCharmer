...
from cnake_charmer.cy.simulation.life_board_steps_class import life_board_steps_class as cy_func
from cnake_charmer.py.simulation.life_board_steps_class import life_board_steps_class as py_func
