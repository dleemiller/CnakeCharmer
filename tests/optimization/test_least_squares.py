...
from cnake_charmer.cy.optimization.least_squares import least_squares as cy_func
from cnake_charmer.py.optimization.least_squares import least_squares as py_func
