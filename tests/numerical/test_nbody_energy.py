...
from cnake_charmer.cy.numerical.nbody_energy import nbody_energy as cy_nbody_energy
from cnake_charmer.py.numerical.nbody_energy import nbody_energy as py_nbody_energy
