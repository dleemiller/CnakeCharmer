...
from cnake_data.cy.numerical.euclid_distance_pair import euclid_distance_pair as cy_func
from cnake_data.py.numerical.euclid_distance_pair import euclid_distance_pair as py_func
