...
from cnake_data.cy.simulation.schelling_segregation import schelling_segregation as cy_func
from cnake_data.py.simulation.schelling_segregation import schelling_segregation as py_func
