...
from cnake_data.cy.string_processing.alignment_identity import alignment_identity as cy_func
from cnake_data.py.string_processing.alignment_identity import alignment_identity as py_func
