...
from cnake_charmer.cy.numerical.probability_to_phred_sum import probability_to_phred_sum as cy_func
from cnake_charmer.py.numerical.probability_to_phred_sum import probability_to_phred_sum as py_func
