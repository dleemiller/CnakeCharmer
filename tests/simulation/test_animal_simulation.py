...
from cnake_charmer.cy.simulation.animal_simulation import animal_simulation as cy_func
from cnake_charmer.py.simulation.animal_simulation import animal_simulation as py_func
