...
from cnake_data.cy.numerical.log_sum_exp import log_sum_exp as cy_log_sum_exp
from cnake_data.py.numerical.log_sum_exp import log_sum_exp as py_log_sum_exp
