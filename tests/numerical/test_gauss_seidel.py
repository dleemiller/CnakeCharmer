...
from cnake_charmer.cy.numerical.gauss_seidel import gauss_seidel as cy_func
from cnake_charmer.py.numerical.gauss_seidel import gauss_seidel as py_func
