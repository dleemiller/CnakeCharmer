...
from cnake_data.cy.math_problems.integer_sqrt_newton import integer_sqrt_newton as cy_func
from cnake_data.py.math_problems.integer_sqrt_newton import integer_sqrt_newton as py_func
