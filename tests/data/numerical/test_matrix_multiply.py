...
from cnake_data.cy.numerical.matrix_multiply import matrix_multiply as cy_func
from cnake_data.py.numerical.matrix_multiply import matrix_multiply as py_func
