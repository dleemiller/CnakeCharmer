...
from cnake_charmer.cy.simulation.nbody_verlet import nbody_verlet as cy_func
from cnake_charmer.py.simulation.nbody_verlet import nbody_verlet as py_func
